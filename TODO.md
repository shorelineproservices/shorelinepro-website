...
- [ ] **Process page: Sherwin-Williams product specs** — research actual current specs (application method, coverage rate, dry/recoat time, recommended surfaces) for SuperPaint, Duration, Emerald Urethane Trim Enamel, Latitude, WoodScapes (stain), SuperDeck — via WebSearch, don't rely on memory since specs/naming can change. Add a materials/specs section to process.html so it reads as genuinely technical, top-of-industry content, not generic contractor copy.
